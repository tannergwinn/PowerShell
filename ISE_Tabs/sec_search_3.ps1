...
$CSVPath = "\\10.1.103.10\Users\Public\Documents\Dropbox\wpscripting\OSN (09-18-2014) codeOnly_AfterDrop.csv";
...
Get-ChildItem $SearchDir\* -recurse -filter *$Code* -Include "*finalstatement*.pdf" | Copy-Item -Destination $DestDir;
