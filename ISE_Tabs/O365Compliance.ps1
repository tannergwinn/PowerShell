...
#Setup search
New-ccComplianceSearch -Name "Phishing 09.22.16" -ExchangeLocation all -ContentMatchQuery 'From:maxwellcarton120@outlook.com'
...
Start-ccComplianceSearch "Phishing 09.22.16"
